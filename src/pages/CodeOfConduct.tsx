  ...
  return (
    <MainLayout>
      <article className="prose prose-invert max-w-none">
        <h1 className="text-foreground text-3xl font-bold mb-6">Contributor Covenant Code of Conduct</h1>
        
        <hr className="border-border my-6" />
        
        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">Our Pledge</h2>
        ...
        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">Our Standards</h2>
        ...
        <p className="text-foreground/90 mt-6 mb-4">
        ...
        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">Enforcement Responsibilities</h2>
        <p className="text-foreground/90">
        ...
        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">Scope</h2>
        <p className="text-foreground/90">
        ...
        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">Enforcement</h2>
        <p className="text-foreground/90">
          Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at patrick.marsceill@gmail.com. All complaints will be reviewed and investigated promptly and fairly.
        </p>
        <p className="text-foreground/90 mt-4">
        ...
        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">Enforcement Guidelines</h2>
        <p className="text-foreground/90 mb-4">
        ...
        <h3 className="text-xl font-bold text-foreground mt-6 mb-3">1. Correction</h3>
        <p className="text-foreground/90">
        ...
        <h3 className="text-xl font-bold text-foreground mt-6 mb-3">2. Warning</h3>
        <p className="text-foreground/90">
        ...
        <h3 className="text-xl font-bold text-foreground mt-6 mb-3">3. Temporary Ban</h3>
        <p className="text-foreground/90">
        ...
        <h3 className="text-xl font-bold text-foreground mt-6 mb-3">4. Permanent Ban</h3>
        <p className="text-foreground/90">
        ...
        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">Attribution</h2>
        <p className="text-foreground/90">
